...
module.exports.trajets = {
    ...
    byLieuDepArrHeure: (lieuDep, lieuArr, heure) => get(`select Id_conducteur, Prix, Heure, Heure_Arrivee, Id_lieu_depart, Id_lieu_arrivee, Nb_places from TRAJET where Id_lieu_depart=${lieuDep} and Id_lieu_arrivee=${lieuArr} and Heure > ${heure}`),
